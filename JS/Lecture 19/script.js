...
// by class - document.getElementByclassName('header1') - then it will show HTMLCollection as multiple elements can have same class - it is like array(not exactly behaves like it) and also can be accessed obj[0] - it will show first element inside HTMLCollection 
